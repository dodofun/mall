      ...
      {status === 1 && !payed && !isBuss && (
        <View className="doing">
          <View className="left-1">
            ...
            />
            <View className="wexinpay-text">
              <View className="wexinpay-text-1">微信</View>
              <View className="wexinpay-text-2">微信支付更加安全</View>
            </View>
          </View>
          <View className="right-1">
            <Image
              className="icon"
              src="https://ydhl-assets.oss-cn-beijing.aliyuncs.com/images/mall/%E9%80%89%E4%B8%AD%402x.png"
            />
          </View>
        </View>
      )}
